...
public class BankAccountDAO extends GeneralDAO{
    public BankAccountDAO(Connection conn) {
        super(conn);
    }

    public BankAccountDAO(Connection conn, String language, String country) {
        super(conn, language, country);
    }

    public BankAccount getAccountsById(int id) throws SQLException {
    ...
    public List<BankAccount> getAccountsByUserId(int userid) throws SQLException{
        ...
        String query = "SELECT * FROM bank_account WHERE userid = ? ORDER BY id ASC";
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
    ...
    public BankAccount getAccountByUserIdAndName(int userid, String name) throws SQLException{
        ...
        String query = "SELECT * FROM bank_account WHERE userid = ? AND name = ?";
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
